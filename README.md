...
`speech/voices/critic.wav` are demo voice prompts from the
...
MIT license. `speech/make_critic_voice.py` can regenerate a Kokoro-based
alternative for CRITIC, which is not what currently ships.
